...
public class GameData implements Serializable {
	...
	int pX, pY, heroHealth, keyNum, potionNum;
	int[][][] map;
	...
	void printMap() {
		...
		System.out.print(
				"Health:" + Integer.toString(heroHealth) + "  KeyNum:" + Integer.toString(keyNum) + "  PotionNum:" + Integer.toString(potionNum) + "  Menu:press 0\n");
		System.out.print("Use 'e' to use potion");
	}
